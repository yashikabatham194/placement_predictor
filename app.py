...
st.markdown('<div style="display:flex;justify-content:center"><div class="footer-chip">Random Forest tuned via RandomizedSearchCV | Student Placement Prediction dataset</div></div>', unsafe_allow_html=True)
